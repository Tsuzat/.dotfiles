...
alias cls="clear"
alias sde="sudo -E"
alias updateAll="sudo -E pacman -Syu && sudo -E pkgfile --update"
alias updateGaruda="sudo -E garuda-update && sudo -E pkgfile --update"
alias inst="sudo -E pacman -S"
alias uninst="sudo -E pacman -Rns"
alias del="rm -rf"
...
function pyProject
    ...
    if test "$count" = 2
        ...
        python -m venv $argv[2] && source ./$argv[2]/bin/activate.fish
    else
