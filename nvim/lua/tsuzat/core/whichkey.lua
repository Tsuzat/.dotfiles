...
M.mappings = {
  ...
  c = {
    name = "CompetiTest",
    a = { "<cmd>CompetiTestAdd<cr>", "Add Test" },
    d = { "<cmd>CompetiTestDelete<cr>", "Delete Test" },
    e = { "<cmd>CompetiTestEdit<cr>", "Edit Test" },
    r = { "<cmd>CompetiTestRun<cr>", "Run Tests" },
    t = { "<cmd>CompetiTestReceive testcases<cr>", "Receive Testcases" },
  },
  f = {
    name = "Flutter Tools",
